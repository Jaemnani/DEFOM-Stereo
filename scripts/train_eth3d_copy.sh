...
python -m torch.distributed.launch --nproc_per_node=1 --master_port=9994 train_stereo.py \
--distributed \
--launcher pytorch \
--gpu_ids 0 \
--name defomstereo_vits_eth3d_pretrain \
--batch_size 2  \
--num_workers 4  \
...
# CHECKPOINT_DIR=chxeckpoints/defomstereo_vitl_eth3d && \
# mkdir -p ${CHECKPOINT_DIR} && \
